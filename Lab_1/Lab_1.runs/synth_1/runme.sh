...
HD_PWD='C:/Users/Student/Desktop/152BFall25/CSM152B/Lab_1/Lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sixteen_bit_alu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sixteen_bit_alu.tcl
