...
HD_PWD='C:/Users/Student/Desktop/152BFall25/Lab_1/Lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m41.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m41.tcl
